            ...
            >
              ...
              <div className="mt-6">
                ...
                <textarea
                  ...
                  onBlur={(ev) => updateOutcome(e.id, ev.target.value)}
                  placeholder="What happened next? What would you do differently?"
                  className="mt-2 min-h-[88px] w-full rounded-lg border border-stone-200 bg-white px-3 py-2 text-sm text-stone-800 placeholder:text-stone-400 focus:border-stone-400 focus:outline-none"
                />
              </div>
